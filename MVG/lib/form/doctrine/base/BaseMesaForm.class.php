...
abstract class BaseMesaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'jugador2_id'      => new sfWidgetFormInputText(),
      'tiempo_emparejar' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'jugador2_id'      => new sfValidatorInteger(array('required' => false)),
      'tiempo_emparejar' => new sfValidatorInteger(array('required' => false)),
