...
/**
 * Intervalo filter form base class.
 *
 ...
 */
abstract class BaseIntervaloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'total_tags' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'total_tags' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('intervalo_filters[%s]');
