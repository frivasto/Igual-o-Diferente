...
abstract class BaseItemColeccionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'video1'         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'video1'         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'video2'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Video'), 'column' => 'id')),
