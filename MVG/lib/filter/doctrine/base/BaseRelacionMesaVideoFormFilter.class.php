...
abstract class BaseRelacionMesaVideoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'respuesta_real' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'respuesta_real' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
