...
abstract class BaseMesaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'jugador2_id'      => new sfWidgetFormFilterInput(),
      'tiempo_emparejar' => new sfWidgetFormFilterInput(),
      'coleccion_id'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'jugador2_id'      => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'tiempo_emparejar' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'coleccion_id'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
